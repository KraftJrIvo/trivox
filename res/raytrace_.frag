...
void main() {
    ...
    if (raytrace_sphere(start, dir, vec3(0), 0.1) || raytrace_sphere(start, dir, vec3(1., 0., 0.), 0.1) || raytrace_sphere(start, dir, vec3(0., 0., 1.), 0.1) || raytrace_sphere(start, dir, vec3(0., 1., 0.), 0.1))
        col = vec3(1.0);
